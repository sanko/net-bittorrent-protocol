...
#
like dies { build_extended( undef, {} ) },    qr[message id], 'build_extended(undef, { }) == undef';
like dies { build_extended( -1,    {} ) },    qr[message id], 'build_extended(-1, { })    == undef';
like dies { build_extended( '',    {} ) },    qr[message id], q[build_extended('', { })    == undef];
like dies { build_extended( 0,     undef ) }, qr[payload],    'build_extended(0, undef)   == undef';
like dies { build_extended( 0,      2 ) },    qr[payload],    'build_extended(0, 2)       == undef';
like dies { build_extended( 0,     -2 ) },    qr[payload],    'build_extended(0, -2)      == undef';
like dies { build_extended( 0,     '' ) },    qr[payload],    q[build_extended(0, '')      == undef];
